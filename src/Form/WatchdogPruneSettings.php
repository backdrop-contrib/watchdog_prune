...
class WatchdogPruneSettings extends ConfigFormBase {
  ...
  public function buildForm (array $form, FormStateInterface $form_state) {
    ...
    $phpdate_reference = Link::fromTextAndUrl($this->t('PHP Date Manual'), Url::fromUri('http://php.net/manual/en/datetime.formats.relative.php', array('attributes' => array('target' => '_blank'))))->toString();
